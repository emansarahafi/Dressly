      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {items.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {items.map((item) => {
              const code = item?.code || item?.id || item?.product_code || item?.productCode || "";
              const name = item?.name || item?.product_name || item?.productName || "Untitled";
              const priceObj = item?.price || item?.prices?.[0] || {};
              const priceVal = priceObj?.formattedValue || priceObj?.formattedPrice || priceObj?.formatted || "";
              const imageUrl = (item?.images && item.images[0]?.url) || item?.product_image || item?.image || (item?.images && item.images[0]?.src) || "";
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <a
                      href={`https://www2.hm.com/en_us/productpage.${code}.html`}
                      target="_blank"
